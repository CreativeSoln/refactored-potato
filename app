...
// ============================================================================
// PARAM  (STRUCTURE SUPPORT ADDED HERE)
// ============================================================================
...
export const parseDiagLayerContainer = (doc, h, idIndex) => {
  ...
  // Everything that can be referenced
  ...
  // Container object exactly like your screenshot
  const container = {
    protocols: [],
    functionalGroups: [],
    baseVariants: [],
