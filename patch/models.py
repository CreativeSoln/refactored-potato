...
class OdxParam:
    ...
    # UI-preferred value fields
    value: str = ""           # preferred over displayValue
    displayHex: str = ""      # hex view if available
    displayValue: str = ""    # legacy/fallback

    attrs: Dict[str, str] = field(default_factory=dict)
    children: List['OdxParam'] = field(default_factory=list)
    isSelectableFor22: Optional[bool] = None
...
class OdxService:
    ...
    didNormalized: str = ""
    requestDidHex: str = ""  # DID-centric UI field
    infoText: str = ""
...
class OdxDatabase:
    ...
    allDops: Dict[str, Any] = field(default_factory=dict)
    allCompus: Dict[str, Any] = field(default_factory=dict)
    allUnitsMap: Dict[str, Any] = field(default_factory=dict)
